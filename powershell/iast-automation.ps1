...
#Variables
$wiAPIurl = '10.2.0.19:8083'
$sscURL = 'http://10.2.0.15:8080/ssc/'
$applicationVersionID = '10002' # Application version ID in Fortify SSC for IWAPharmacyDirect
$sscToken = 'Y2U2MzE1NzctYTBjYS00ZjEzLWJmYWMtZmRhMDcxY2Q0OTg4'

$scanURL = 'http://10.2.0.20:8585/iwa/'
$crawlAuditMode = 'CrawlandAudit'
$scanName = 'IWAPharmacyDirect'
